...
namespace Samlingsklasser
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("8. övning 1.");
            Console.WriteLine("9. övning 2.");
            Console.WriteLine("10. övning 3.");
            Console.WriteLine("11. övning 4.");
        ...
        static void ovning2()
        {
            ...
            while (true)
            {
                ...
                list.Add(num);
                Console.WriteLine("medelvärdet är: " + list.Average().ToString());
            }
        ...
        static void ovning4()
        {
            ...
            Dictionary<string, int> korten = new Dictionary<string, int>();
            var suits = new string[] { "C", "H", "D", "S" };
            for (int i = 0; i <= 3; i++)
            {
                korten.Add(suits[i] + "A", 1);
                for (int a = 2; a <= 10; a++)
                {
                    korten.Add(suits[i] + a.ToString(), a);
                }
                korten.Add(suits[i] + "J", 11);
                korten.Add(suits[i] + "Q", 12);
                korten.Add(suits[i] + "K", 13);
            }
            var keys = korten.Keys.ToArray();
            int counter = 0;
            for (int i = 0; i < 1000; i++)
            {
                int random1 = num.Next(0, keys.Length);
                int random2 = num.Next(0, keys.Length);

                if (korten[keys[random2]] == korten[keys[random1]])
                {
